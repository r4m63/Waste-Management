...
Важная часть платформы — **многофункциональная админ-панель**, построенная вокруг гибких data-grid таблиц.  
В админ-интерфейсе реализованы:
- сортировка и фильтрация по любым колонкам,
- быстрый поиск и комбинированные фильтры,
- серверная пагинация для больших наборов данных,
- единый UX-подход для всех управляемых сущностей (маршруты, точки, водители, транспорт, фракции, контейнеры, заявки и инциденты).
...
### 🧩 Админ-панель и Data Grid
- Гибкие таблицы по всем доменным разделам
- Фильтрация и сортировка по любым колонкам
- Текстовый поиск и комбинированные фильтры
- Пагинация и серверная постраничная выборка
- Единые паттерны управления данными в UI
...
| :----------------- | :--------------------------- | :---------------------------------------- | :---------------: |
| `admin-frontend`   | Многофункциональная панель администратора с расширенными data-grid таблицами (поиск, фильтры, сортировки, пагинация) | React, Vite, Tailwind, shadcn/ui, AG Grid |      `21001`      |
